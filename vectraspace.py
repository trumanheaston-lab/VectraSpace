  ...
  <div id="sidebar">
    ...
    <div id="scroll">
      ...
      <div id="demo-banner" style="display:none;margin-bottom:12px;padding:8px 10px;
        ...
        <a href="/login" class="signin-btn" style="margin-top:8px;display:inline-flex;">Sign In / Create Account →</a>
      </div>
...
async function initUserState() {
  ...
  if (currentUser && currentUser.username) {
    ...
    userActions.innerHTML = '<a href="/login" class="signin-btn"><svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round"><path d="M15 3h4a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-4"/><polyline points="10 17 15 12 10 7"/><line x1="15" y1="12" x2="3" y2="12"/></svg>Sign In / Create Account</a>';
